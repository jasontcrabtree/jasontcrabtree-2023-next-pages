...
<GIFImage
  gifSrc="https://res.cloudinary.com/jasontcrabtree/image/upload/v1581088985/Portfolio-2020/hello-world-count.gif"
  gifAlt="GIF of CharacterCounter showing the 12 characters in the phrase Hello World"
/>
...
<CustomLazyImage
  alt="The Ideal Use-Case. 1. Realise Product Need, 2. Quickly Use Product, 3. Get back
to Original Task!"
  src="/assets/images/charactercounter/cc-use-case-flow.png"
/>
...
<CustomLazyImage
  alt="Image of Right-Click Services AppleScript Function to Count Word and Characters"
  src="/assets/images/charactercounter/apple-script-counter.png"
/>
...
<CustomLazyImage
  alt="Tweet requesting a macOS MenuBar Character Counting App"
  src="/assets/images/charactercounter/tweet-productrequest.png"
/>
...
<CustomLazyImage
  alt="A hacky solution to my character counting goals — heavily taken from w3schools"
  src="/assets/images/charactercounter/js-character-counter.png"
/>
...
<CustomLazyImage
  alt="The first version of CharacterCounter. Functional, but not pretty."
  src="/assets/images/charactercounter/character-counter-v1.png"
/>
...
<CustomLazyImage
  alt="Different Iterations of Formatting/Layout and the Final Layout used to plan the
HTML File"
  src="/assets/images/charactercounter/redlining-and-sections.png"
/>
...
<CustomLazyImage
  alt="The Finished Product. The final image of Character Counter on Desktop and Mobile"
  src="/assets/images/charactercounter/cc-responsive-views.png"
/>
...
<GIFImage
  gifSrc="https://res.cloudinary.com/jasontcrabtree/image/upload/v1581088985/Portfolio-2020/clicked-copy-animation.gif"
  gifAlt="GIF of the copy button in action, including the button label changing. Fancy."
/>
...
<CustomLazyImage
  alt="Pingdom Website Speed Test: Load time 452 ms"
  src="/assets/images/charactercounter/pingdom-speed-results.png"
/>
