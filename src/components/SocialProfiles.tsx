...
function SocialProfiles() {
  return (
    <ul className="flex md:flex-col flex-row md:gap-1 gap-6">
      <li>
      ...
      <li>
        <a href="https://www.linkedin.com/in/jasontcrabtree/" aria-label="LinkedIn-link">
          <LinkedInSvg />
        </a>
      </li>
      <li>
